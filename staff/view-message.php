...
$getstaffinfo="SELECT doc_id,fname,lname,email,gender FROM doctors WHERE username='$staffuname'";
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12 mail_listing">
                                    ...
                                    <div class="b-all p-20">
                                        <p class="p-b-20">click here to <a href="replay-message.php?id=<?php echo $fetchstaffinfo['doc_id'] ?>">Reply</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>

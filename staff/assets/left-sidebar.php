		...
		<ul class="nav" id="side-menu">
			...
			<li class="user-pro">
				<a href="#" class="waves-effect">
					...
					if($rowimg["gender"]=='male'){ ?> <img src="../plugins/images/users/staff-male.png" class="img-circle"><?php } else { ?><img src="../plugins/images/users/staff-female.png" class="img-circle"> <?php } ?>

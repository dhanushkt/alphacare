...
$countapoint=mysqli_query($connection,"SELECT * FROM appointments WHERE (status='In Process')");
        ...
        <div id="page-wrapper">
            <div class="container-fluid p-b-0">
					...
					<div class="col-md-12 col-sm-10 hvr-wobble-horizontal">
						<div class="card card-inverse">
							...
							<div class="card-img-overlay" style="padding-top: 5px">
								<h4 class="card-title text-uppercase">WELCOME <?php echo $rowimg['fname'].' '.$rowimg['lname']; ?></h4>
								<p class="card-text" id="cText">You are logged-in to STAFF control panel, here are some of the basic information about hospital and some basic functions to perform. </p>
                ...
                <div class="row p-t-10 p-b-0">
                    ...
                    <div class="col-md-3 col-sm-6 Hoveranimatew hvr-float" data-toggle="tooltip" data-original-title="Add new visitor" onClick="window.location='add-visitor.php'">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                <i class="fa fa-user-plus bg-black Hoveranimatewrd"></i>
                                <div class="bodystate p-t-10">
									<h4><b>ADD VISITOR</b></h4>

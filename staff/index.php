					...
					<div class="col-md-12 col-sm-10 hvr-wobble-horizontal">
						<div class="card card-inverse">
							...
							<div class="card-img-overlay" style="padding-top: 5px">
								...
								<p class="card-text">You are logged-in to STAFF control panel, here are some of the basic information about hospital and some basic functions to perform. </p>

...
$gettoname=$_GET["id"];
$getfullname="SELECT username,fname,lname,specialist FROM doctors WHERE doc_id='$gettoname'";
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-13 p-l-0">
											...
											<select required class="form-control" name="to_uname">
												...
												<option value="<?php echo $fullnamerow['username']; ?>" selected hidden><?php echo $fullnamerow['fname'].' '.$fullnamerow['lname'].' , '.$fullnamerow['specialist']; ?></option>

                        ...
                        <div class="white-box">
                            <div class="row">
                                <div class="col-md-4 col-sm-4 text-center">
                                    <a href="edit-staff-profile.php?id=<?php echo $result["s_id"]; ?>"><?php if($result["gender"]=='male'){ ?> <img src="../plugins/images/users/staff-male.png" class="img-square img-responsive"><?php } else { ?><img src="../plugins/images/users/staff-female.png" class="img-square img-responsive"> <?php } ?>  </a>
                                </div>

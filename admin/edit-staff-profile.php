...
$query="SELECT fname, lname, username, email, gender, floor, phone, password FROM staffs WHERE s_id='$id'";
...
if(isset($_POST['updateprofile']))
{
	...
	$floor=mysqli_real_escape_string($connection,$_POST['floor']);
	$phone=mysqli_real_escape_string($connection,$_POST['phone']);

	$uquery="UPDATE staffs SET fname='$fname', lname='$lname', username='$username', email='$email', gender='$gender', floor='$floor', phone='$phone' WHERE s_id='$id'";
	$uresult = mysqli_query($connection, $uquery);
	if($uresult)
	{
		$squery="SELECT fname, lname, username, email, gender, floor, phone FROM staffs WHERE s_id='$id'";
...
if(isset($_POST['changepw']))
{
	...
	if($oldpw==$row["password"])
	{
		...
		$pwquery="UPDATE staffs SET password='$npw' WHERE s_id='$id'";
                        ...
                        <div class="white-box">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="profile">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Floor</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row["floor"]; ?></p>
                                        </div>

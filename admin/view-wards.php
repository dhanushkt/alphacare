                ...
                <!--row -->
                		...
                		<section>
                                <div class="sttabs tabs-style-bar">
                                    <nav>
                                        <ul>
                                            <li><a href="#section-bar-1" class="sticon ti-reload"><span>Available</span></a></li>
                                            <li><a href="#section-bar-2" class="sticon ti-time"><span>Occupied</span></a></li>
                                            <li><a href="#section-bar-3" class="sticon ti-check-box"><span>2nd floor</span></a></li>
                                            <li><a href="#section-bar-4" class="sticon ti-na"><span>3rd floor</span></a></li>
                        ...
                        <div class="white-box">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-8">
									<h5 class="box-title m-b-0"><?php echo $getwardresult["ward_no"]; ?> </h5>
                                    <!--<h3 class="box-title m-b-0"><?php// echo $getwardresult["name"]; ?></h3>--> <small>floor: <?php echo $getwardresult["floor"]; ?></small>
                                    <p class="p-0">
										<!--<a href="mailto:<?php // echo $getwardresult["email"]; ?>"> <?php // echo $getwardresult["email"]; ?> </a> <br> --->
										<i class="fa fa-calendar"></i><?php //$datea=$getwardresult['doa'];
										//$myDateTime = DateTime::createFromFormat('Y-m-d', $datea);
										//$doac = $myDateTime->format('d-m-Y');  echo ' '.$doac; ?> <br>
										<i class="fa fa-user-md"></i><?php //echo ' Dr. '.$getwardresult["fname"].' '.$getwardresult["lname"]; ?> <br>
										<i class="fa fa-phone"></i><?php //echo ' '.$getwardresult["phno"]; ?> <br>
										
										<a href="process-appointment.php?id=<?php //echo $getwardresult["ap_token"]; ?>" class="fcbtn btn btn-info bootpopup" >Schedule/Cancel</a>

...
$query="SELECT doc_id,fname, lname, username, email, gender, qualification, specialist, phone, password FROM doctors WHERE username='$ausername'";
...
if(isset($_POST['updateprofile']))
{
	...
	if($uresult)
	{
		$squery="SELECT doc_id,fname, lname, username, email, gender, qualification, specialist, phone FROM doctors WHERE username='$ausername'";

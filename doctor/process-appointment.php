											...
											<div class="row">
													...
													<div class="radio-list">
														<label class="radio-inline p-0">
															<div class="radio radio-info">
																<input type="radio" name="apstatus" id="radio1" value="Scheduled" checked>
												...
												<div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" data-date-format="hh:mm:ss" id="time" class="form-control clockpicker"  name="aptime">
                                                     </div>
                                                </div>
											</div>
                                            <!--/row-->

                        ...
                        <div class="white-box">
                            <div class="row">
                                <div class="col-md-4 col-sm-4 text-center">
                                    <a href="#"><?php if($result["gender"]=='male'){ ?> <img src="../plugins/images/users/male-patient.png" class="img-circle img-responsive"><?php } else { ?><img src="../plugins/images/users/female-patient.png" class="img-circle img-responsive"> <?php } ?>  </a>
                                </div>
